...
<div class="content-container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<h3>
				<spring:message code="label.shareAccount.redeemShares" />
			</h3>
			<form class="form-horizontal" role="form" id="redeemShareForm">
				<fieldset>
					<br>
					<div class="form-group">
						...
						<div class="col-sm-4 hideTag">
							<input class="form-control" datetype="date" id="requestedDate" name="requestedDate" type="text" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-5">
							<div class="btn-group">
								...
								<button type="button" class="btn btn-primary" id="redeem_share">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.nest({
			...
			callback : "b_redeemInit"

		});
		$('#redeem_share').click(function() {

			var formData = $('#redeemShareForm').serializeArray();//获取form所有数据
	...
	function redeemShare(json) {
		$.nest({
			...
			callback : "b_redeemShare"
		});
	}
	function b_redeemShare(param) {
		$.setReadOnly('redeemShareForm');
