...
<div class="content-container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<h3>
				<spring:message code="title.shareAccount.application" />
			</h3>
			<form class="form-horizontal" role="form" id="newForm">
				<fieldset>
					...
					<div class="form-group hideTag">
						<label class="col-sm-2 control-label" for="externalId" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.externalId" />
						</label>
						<div class="col-sm-4">
				...
				<fieldset>
					<legend></legend>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="currencyLabel" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.currency" />
						</label>
						<div class="col-sm-4">
							<p class="form-control-static" id="currencyLabel"></p>
						</div>
						<label class="col-sm-2 control-label" for="currencyDP" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.decimalPlaces" />
						</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label" for="nominalpricevalue" style="font-size: 16px; font-weight: normal">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="currencyMultiples" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.inMultiplesOf" />
						</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="minimumActivePeriod" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.minActivePeriod" />
						</label>
						<div class="col-sm-2">
						...
						<label class="col-sm-2 control-label" for="lockinPeriodFrequency" style="font-size: 16px; font-weight: normal">
							<spring:message code="label.shareAccount.lockInPeriod" />
						</label>
						<div class="col-sm-2">
				...
				<fieldset>
					...
					<div class="form-group" id="chargeAreaMark">
						<label class="col-sm-2 control-label" for="chargeId" style="font-size: 16px; font-weight: normal">
					...
					<div class="form-group">
						<div class="col-sm-offset-10">
							<div class="btn-group">
								...
								<button type="button" class="btn btn-primary" id="submit_share">
					...
					function() {
						...
						$('#productId').change(
										function() {
											...
											$("#productId option[value='0']").remove();
						...
						$('#submit_share').click(
										function() {
											...
											$.each(
													formData,
													function() {
														if (this.value != ''&& this.value != "select one") {
	...
	function createShare(json) {
		$.nest({
			...
			data : {
				...
				"dataType" : "POST",
				"mydata" : json,
				"url" : "api.v1.accounts.share"
			},
			callback : "b_createShare"
		});
	}
	function b_createShare(param) {
		var resultId = param.resourceId;
		window.location.href = "loadPage.do?nextPage=client.shareAccount.shareAccount&shareAccountId="
				+ resultId
	}
