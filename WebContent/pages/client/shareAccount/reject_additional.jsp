...
<div class="content-container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<h3>
				<spring:message code="title.shareAccount.RSPR" />
			</h3>
			<form class="form-horizontal" role="form" id="rejectAddShareForm">
				<fieldset>
					<br>
					...
					<div class="form-group">
						<div class="col-sm-offset-10">
							<div class="btn-group">
								...
								<button type="button" class="btn btn-primary" id="rejectAdd_share">
...
<script type="text/javascript">
	$(document).ready(
			function() {
				 $.nest({
					...
					callback : "rejectAddInit"

				}); 
				$('#rejectAdd_share').click(
						function() {
							var json={};
							var IdArr=[];
	...
	function rejectAddShare(json) {
		$.nest({
			...
			callback : "b_rejectAddShare"
		});
	}
	function b_rejectAddShare(param) {
		$.setReadOnly('rejectAddShareForm');
