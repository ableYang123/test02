...
<body>
	<form class="form-horizontal" id="loanClient" name="loanClient">
	<div>
	...
	<div id="productSelectPage" class="modal-body"
		...
		<div class="col-md-10" style="padding-left: 0px">
			<select id="LoanProductSelectList" onchange="selectProduct()"
				class="form-control" style="width: 200">
				<option value="0" name="defulteProduct" id="defulteProduct"><spring:message code="group.please.select.product" /></option>
			</select>
		</div>
	...
	<div id="informationPage" class="modal-body"
			...
			<div class="col-md-6" style="padding: 5px">
				...
				<div class="form-group" style="padding-left: 0px">
					<input id="submittedOn" name="submittedOn" type="text"
						...
						name="activeDate" local-date="true">
				</div>
			</div>
			<div class="col-md-6 form-group" style="padding: 5px">
				<div class="col-md-4" style="padding: 5px">
					<label
						style="padding-top: 3px; font-size: 16px; font-weight: normal">
		...
		<div class="modal-body" style="height: 60px; padding: 5px">
			<div class="col-md-6" style="padding: 5px">
				<div class="col-md-4" style="padding: 5px">
					<label
						style="padding-top: 3px; font-size: 16px; font-weight: normal">
						<spring:message code="group.first.repayment.on" />
					</label>
				</div>
				<div class="col-md-8" style="padding-left: 0px">
			...
			<div class="col-md-6" style="padding: 5px">
				<div class="col-md-4" style="padding: 5px">
					<label
						style="padding-top: 3px; font-size: 16px; font-weight: normal">
						<spring:message code="group.interest.charged.from" />
					</label>
				</div>
				<div class="col-md-8" style="padding-left: 0px">
		...
		<div class="modal-body" style="height: 60px; padding: 5px">
			...
			<div class="col-md-6" style="padding: 5px">
				<div class="col-md-4" style="padding: 5px">
					<label style="font-size: 14px; font-weight: normal"> <spring:message
							code="group.interest.free.period" />
					</label>
				</div>
				<div class="col-md-8" style="padding-left: 0px">
		...
		<div class="modal-body" style="height: 60px; padding: 5px">
			<div class="col-md-6" style="padding: 5px">
				...
				<div class="col-md-8" style="padding-left: 0px">
					<select id="RepaymentStrategy" name="RepaymentStrategy" class="form-control"
						style="width: 200px">
					</select>
				</div>
			</div>
		...
		<div id="collateralTable" class="modal-body"
			...
			<table id="collateralList" style="width: 868px">
				<thead style="background-color: #EAEAEA; width: 100%">
					...
					<th style="width: 50px"><spring:message code="group.actions" /></th>
				</thead>
				<tbody>
				</tbody>
			</table>
	...
	var LoanListUrl;
		$(document).ready(function() {
			...
			if(clientId && groupId)
				LoanListUrl = "api.v1.loans.template?activeOnly=true&clientId="
					+ clientId+ "&groupId="+groupId+"&staffInSelectedOfficeOnly=true&templateType=jlg";
		...
		function getInformationPageContent(productId) {
			var LoanProductDetail;
				...
				if(clientId && groupId)
					LoanProductDetail = "api.v1.loans.template?activeOnly=true&clientId="
							+clientId+"&groupId="+ groupId+ "&productId="+ productId
						+ "&staffInSelectedOfficeOnly=true&templateType=jlg";
			$.nest({
						url : "<c:url value='/fineract.do'/>",
						type : "get",
						data : {
		...
		function apendChargesList(id, name, type, collection, amount) {
			...
			$("#chargesList")
					.append(
							"<tr id='chage"+id+"' name='chage'><td style='width:50px'>"
									+ name
									+ "<input value='"+id+"' style='display:none'></td><td>"
									+ type
									+ "</td><td><input id='chargesAmount"+id+"' placeholder='金额' style='width: 100px' value='"+amount+"'></td>"
									+ "<td class='ng-binding'>"
									+ collection
									+ "</td><td><div><input type='text' datetype='date' name='date' class='datetime'></div></td>"
									+ "<td><input name='submit' style='margin-top:4px' onclick='deleteCharge("
									+ id
									+ ")' type='image' src='${pageContext.request.contextPath}/images/t03.png' /></td></tr>");
			$.datetimepicker();
		...
		function IntegrationParameter() {
			var json = {
				...
				/* 7-2.2 */
				"loanTermFrequencyType" : $.getSelectedValue("termFrequencyTypeOptions"),
				"locale" : "en",
				/* 8-1 */
			...
			getAllValue(json)
			/* 参数个性化-客户贷款，组贷款，和JLG贷款的不同参数处理 */
			if(clientId){
				json.clientId = clientId;
				json.loanType ="individual";
			}
		...
		function savingLoanSuccess(param) {
			if(param != null || param != '')
				window.location.href="loadPage.do?nextPage=client.loanDetail&loanId="+param.loanId+"&requestType="+requestType;
		}
