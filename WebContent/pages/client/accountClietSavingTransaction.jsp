...
<%@ include file="../common/header.jsp"%>
	...
	<form class="form-horizontal" id="accountDeposit" name="accountDeposit">
		...
		<!-- 		https://192.168.1.10/fineract-provider/api/v1/runreports/Client%20Saving%20Transactions?output-type=PDF&tenantIdentifier=default&locale=zh_CN&R_startDate=2017-09-29&R_endDate=2017-10-18&R_savingsAccountId=hwm000000664	 -->
			</div>
		</div>
	</form>
	...
	$(document).ready(
		function() {
			...
			$.getWidget("save").click(function(){
				...
				var requestParam = "?docPath=api.v1.runreports.Client Saving Transactions&output-type=PDF&tenantIdentifier=default&locale=zh_CN&R_startDate="+startDate+"&R_endDate="+endDate+"&R_savingsAccountId="+savingsAccountId;
