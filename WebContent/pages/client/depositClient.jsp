...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			<form class="form-horizontal" id="depositClient" name="depositClient">
				<fieldset>
					<legend><spring:message code="lable.deposit.money.to.saving.account"/></legend>
				...
				$.getWidget("save").click(function() {
					...
					$.nest({
						...
						data : {
							"dataType" : "POST",
							"mydata" : json,
							"url" : "api.v1.savingsaccounts."+savingAccountId+".transactions?command=deposit"
						},
						callback : "callback"
					});
				});
