...
<body style="background-color: f8f8f8">
	...
	function viewReceipt(){
		$("#transactionList tr").each(function(){
		    ...
		    $.openWindow('<c:url value="/loadPage.do?nextPage=client.loanRunreport"/>');
		})
	}
	...
	function viewEntries(){
		$("#transactionList tr").each(function(){
			transactionId = $(this).find("td:first").text();
			$.openWindow('<c:url value="/loadPage.do?nextPage=client.journalEntries"/>');
		})
	}
	...
	function waiveLoanCharge(){
		$("#loanChargeList tr").each(function(){
		    ...
		    $.openWindow('<c:url value="/loadPage.do?nextPage=client.waiveLoanCharge"/>');
		})
	}
	...
	function loanChargeDetail(){
		$("#loanChargeList tr").each(function(){
		    chargeId = $(this).find("td:first").text();
		   // $.openWindow('<c:url value="/loadPage.do?nextPage=client.viewCharge"/>');
		    window.location.href="loadPage.do?nextPage=client.viewCharge&loanId="+loanId+"&chargeId="+chargeId+"&status="+status+"&requestType="+requestType;
		})
	}
	...
	function editLoanCharge(){
		$("#loanChargeList tr").each(function(){
		    chargeId = $(this).find("td:first").text();
			$.openWindow('<c:url value="/loadPage.do?nextPage=client.editLoanCharge"/>');
		})
	}
	...
	$('#Export').click(function(){
		$.openWindow("loadPage.do?nextPage=client.generateReport");
	});
	...
	function noteAdd(){
		isInit = "note";
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.loanNotes"/>');
	}
	
	function documentsUplaod(){
		isInit = "document";
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.loanDocument"/>');
	}
	
	function deleteFile(){
		documentId = grid_document.colVal('id');
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.deleteLoanDocument&loanId='+loanId+'"/>');
	}
	
	$('#addLoanCharge').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.addLoanCharge"/>');
	});
	
	$('#prepayLoans').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.prepayLoan"/>');
	});
	
	$('#forecloures').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.foreclosure"/>');
	});
	...
	$('#undoApprove').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.undoApproveLoanAccount"/>');
	});
	...
	$('#undodisbursal').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.undoDisburseLoanAccount"/>');
	})
	
	$('#disburseToSaving').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.disburseToSaving"/>');
	});
	
	$('#modifyApp').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.editLoan"/>');
	});
	
	$('#reject').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.rejectLoanAccount"/>');
	});
	
	$('#assignLoanOfficer').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.assignLoanOfficer"/>');
	});
	...
	function unAssignLoanOfficer(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.unAssignLoanOfficer"/>');
	}
	
	function changeLoanOfficer(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.changeLoanOfficer"/>');
	}
	
	function addCollateral(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.addCollateral"/>');
	}
	
	function waiveInterest(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.waiveInterest"/>');
	}
	
	function reschedule(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.rescheduleLoan"/>');
	}
	
	function writeOff(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.writeOffLoanAccount"/>');
	}
	
	function closeAsRescheduled(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.closeLoanAccountAsReschedule"/>');
	}
	
	function closeLoan(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.closeLoanAccount"/>');
	}
	...
	function createGuarantos(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.createGuarantor"/>');
	}
	
	function loanScreenReport(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.loanScreenReport"/>');
	}
	
	function recoverGuarantor(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.recoverFromGuarantor"/>');
	}
