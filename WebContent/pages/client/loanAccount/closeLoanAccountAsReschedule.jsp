...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<form class="form-horizontal" id="closeAs" name="closeAs">
		<fieldset>
			<legend><spring:message code="lable.close.loan.account.as.rescheduled"/></legend>
	 ...
	 $(document).ready(function() {
		...
		$.nest({
			...
			data : {
				"dataType" : "GET",
				"mydata" : "",
				"url" : "api.v1.loans."+loanId+".transactions.template?command=close-rescheduled"
			},
			callback : "loan"
		});
		$.getWidget("save").click(function() {
			...
			$.nest({
				...
				data : {
					"dataType" : "POST",
					"mydata" : json,
					"url" : "api.v1.loans."+loanId+".transactions?command=close-rescheduled"
				},
				callback : "callback"
			});
		}); 
