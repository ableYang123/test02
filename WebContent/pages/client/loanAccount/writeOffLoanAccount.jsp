...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<form class="form-horizontal" id="writeOff" name="writeOff">
		<fieldset>
			<legend><spring:message code="lable.write.off"/></legend>
			<div class="form-group">
				<label class="col-sm-2 control-label"> <spring:message code="lable.write-off.on"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" readonly="readonly" name="writeOffAmount" id="writeOffAmount">
				</div>
			</div>
			<div class="form-group">
	 ...
	 $(document).ready(function() {
		...
		$.nest({
			...
			data : {
				"dataType" : "GET",
				"mydata" : "",
				"url" : "api.v1.loans."+loanId+".transactions.template?command=writeoff"
			},
			callback : "loan"
		});
		$.getWidget("save").click(function() {
			...
			$.nest({
				...
				data : {
					"dataType" : "POST",
					"mydata" : json,
					"url" : "api.v1.loans."+loanId+".transactions?command=writeoff"
				},
				callback : "callback"
			});
		}); 
	...
	function loan(param){
		...
		$.assign({
			'writeOffAmount' : param.amount
		});
	}
	function callback(param) {
		$.setReadOnly("writeOff");
