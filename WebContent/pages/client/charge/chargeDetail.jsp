...
<body style="background-color: f8f8f8">
	...
	<div class="card">
		...
		<div style="margin-top: 20px" class="form-group row col-md-12 col-sm-12"">
			<span style="font-size: small;">
				<small>
					<a href="javascript:detail();" style="text-decoration: none;"><span>view client&nbsp;/</span></a>
		...
		<div id="operate" class="form-group" style="position: relative;min-height: 1px;padding-left: 15px;padding-right: 15px;display: none;">
			<div style="float: right !important;position: relative;display: inline-block;vertical-align: middle;">
				...
				<span id="d">
					<a href="javascript:Delete();" style="margin-top: 3px" class="btn btn-primary btn-offset">
	...
	$(document).ready(function(){
		...
		$('#myModal').on('hidden.bs.modal',
				function(event) {
					window.location.href="loadPage.do?nextPage=client.charge.chargeDetail&clientId="+clientId+"&chargeId="+chargeId
				});
	});
	function init() {
		$.nest({
	...
	$('#pay').click(function(){
		$.openWindow("loadPage.do?nextPage=client.charge.payCharge");
	});
	...
	function Delete(){
		$.openWindow("loadPage.do?nextPage=client.charge.deleteCharge");
	}
