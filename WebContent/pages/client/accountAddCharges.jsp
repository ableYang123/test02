...
<%@ include file="../common/header.jsp"%>
					...
					<div id="addChargesDetil" style="display: none">
						...
						<div class="form-group" id="d5" style="display: none">
							<label for=""specifiedDate"" class="col-sm-2 control-label">
								...
								<span style="font-size: 14px; color: #d9534f" id="sp">*</span>
							</label>
							<div class="col-sm-3" >
	...
	<script type="text/javascript">
		...
		function chargeCall(param){
			...
			if(param.chargeTimeType.value.indexOf('Specified') > -1||param.chargeTimeType.value.indexOf('Savings Activation') > -1){
