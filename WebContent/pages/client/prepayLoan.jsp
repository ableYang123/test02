...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			<form class="form-horizontal" id="disburse" name="disburse">
				<fieldset>
					<legend><spring:message code="lable.prepay.loan"/></legend>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" readonly="readonly" class="form-control" id="principalPortion" name="principalPortion">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><spring:message code="lable.interest.amount"/>
							<span style="font-size: 14px; color: #d9534f">*</span>
						</label>
						<div class="col-sm-3">
							<input type="text" readonly="readonly" class="form-control" id="interestPortion" name="interestPortion">
						</div>
					</div>
					<div class="form-group">
	...
	<script type="text/javascript">
		$("#showDetails").click(function () {
			...
			if(s == '-'){
					$.hide('account','cheque','routing','receipt','bank');
					$('#showDetails').prop('value','+');
			}else{
					$.show('account','cheque','routing','receipt','bank');
					$('#showDetails').prop('value','-');
			}
		});
		$(document).ready(function() {
				...
				$.nest({
					...
					data : {
						"dataType" : "GET",
						"mydata" : "",
						"url" : "api.v1.loans."+loanId+".transactions.template?command=prepayLoan"
					},
					callback : "accounts"
				});
				$.getWidget("save").click(function() {
					...
					var json = {
							...
							"transactionDate":$.value('actualDisbursementDate'),
		...
		function accounts(param){
			...
			$.assign({
				...
				'principalPortion' : param.principalPortion,
				'interestPortion' : param.interestPortion
			});
		}
</script>