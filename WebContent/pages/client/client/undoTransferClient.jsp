...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			...
			<form class="form-horizontal" id="undoTransferClient" name="undoTransferClient">
				<fieldset>
					<legend><spring:message code="lable.untransfer.client"/></legend>
	...
	<script type="text/javascript">
				...
				$.getWidget("save").click(function() {
					...
					$.nest({
						...
						data : {
							"dataType" : "POST",
							"mydata" : json,
							"url" : "api.v1.clients."+clientId+"?command=withdrawTransfer"
						},
						callback : "callback"
					});
			});
		...
		function callback(param) {
			$.setReadOnly("undoTransferClient");
