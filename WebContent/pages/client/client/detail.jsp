				...
				<div class="row col-md-12 col-sm-12">
					...
					<span class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						  <li id="csr"><a href="javascript:clientScreenReport();"><spring:message code="lable.screen.reports"/></a></li>
						  <li id="ucs"><a href="javascript:uploadClientSignature();"><spring:message code="lable.upload.signature"/></a></li>
						  <li id="vsi"><a href="javascript:viewStandingInstraction();"><spring:message code="lable.view.standing"/></a></li>
						  <li id="csi"><a href="javascript:createStandingInstraction();"><spring:message code="lable.create.standing.instruction"/></a></li>
						  <li id="nfd"><a href="javascript:newFixedDeposit();"><spring:message code="lable.new.fixed.deposit"/></a></li>
						  <li id="nrd"><a href="javascript:newRecurringDeposit();"><spring:message code="lable.new.recurring.deposit"/></a></li>
						  <li id="cov"><a href="javascript:chargesOverview();"><spring:message code="lable.charges.overview"/></a></li>
						  <li id="sur"><a href="javascript:survey();"><spring:message code="lable.survey"/></a></li>
						</ul>
					</span>
			</div><br><br>
			<div id="closeInfo">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#myModal').on('hidden.bs.modal',
					function(event) {
						window.location.href="loadPage.do?nextPage=client.client.detail&clientId="+clientId+"&userId="+userId
					});
		...
		$.getWidget("savingList").click(function(){
			...
			if(!$.isEmpty(grid2.colVal('id')))	{
				...
				if(depositType == 'Fixed Deposit'){
					...
					window.location.href="loadPage.do?nextPage=client.savingAccount.savingsaccounts&savingsId="+accountId+"&officeId="+fromOfficeId;
				}
			}			
		});
		function closedDetail(){
			var savingsId = grid22.colVal('id');
			window.location.href="loadPage.do?nextPage=client.savingAccount.savingsaccounts&savingsId="+savingsId;
		}
		...
		function payCharge(obj){
			...
			$.openWindow('<c:url value="/loadPage.do?nextPage=client.charge.payCharge"/>');
		}
		/*放弃费用*/
		function waiveCharge(obj){
			...
			$.getWidget("chargeList").click(function(){
				...
				if(!$.isEmpty(grid3.colVal('id')))	{
					chargeId = grid3.colVal('id');
					window.location.href="loadPage.do?nextPage=client.charge.chargeDetail&chargeId="+chargeId+"&clientId="+clientId;
		...
		$('#chargeviews').click(function(){
			window.location.href="loadPage.do?nextPage=client.charge.chargesOverview&clientId="+clientId;
		});
		...
		function survey(){
			$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.createSurvey"/>&clientId='+clientId);
		}
...
/*功能*/
	...
	$('#newLoan').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.loanAccount.loanClient"/>');
	});
	
	$('#newSaving').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.savingClient"/>');
	});
	...
	$('#addCharge').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.chargeClient"/>');
	});
	
	$('#transferClient').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.transferClient"/>');
	});
	
	$('#rejectTransfer').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.rejectTransferClient"/>');;
	})
	
	$('#undoTransfer').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.undoTransferClient"/>');
	});
	
	$('#assignStaff').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.assignStaff"/>');
	});
	
	$('#acceptTransfer').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.acceptTransferClient"/>');
	});
	
	function documentsUplaod(){
		isInit = "document";
		documentId = grid_document.colVal('id');
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.documentClient"/>');
	}
	...
	function deleteFile(obj){
		var trNode = obj.closest('tr');
		documentId = $(trNode).find('div:first').text();
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.deleteDocument"/>');
	}
	
	function deleteIdentity(){
	    identityId = grid_identity.colVal('id');
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.deleteIdentity"/>');
	}
	
	function identitiesAdd(){
		isInit = "identity";
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.identityClient"/>');
	}
	
	$('#imageUpload').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.imageClient"/>');
	});
	
	function noteAdd(){
		isInit = "note";
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.noteClient"/>');
	}
	
	$('#updateDefaultSavings').click(function(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.updateDefaultSavingAccountClient"/>');
	});
	
	function newFixedDeposit(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.fixedDeposit.fixedDepositClient"/>');
	}
	
	function newRecurringDeposit(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.recurringDeposit.recurringDepositClient"/>');
	}
	...
	function Deposit(obj){
		...
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.accountDeposit"/>');
	}
	
	function Withdrawal(obj){
		var trNode = obj.closest('tr');
		savingsId = $(trNode).find('div:first').text();
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.accountWithdrawal"/>');
	}
	
	function approveSaving(obj){
		var trNode = obj.closest('tr');
		savingsId = $(trNode).find('div:first').next;
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.approveSaving"/>');
	}
	
	function unapproveSaving(obj){
		var trNode = obj.closest('tr');
		savingAccountId = $(trNode).find('div:first').next;
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.undoapproval"/>');
	}
	
	function activeAccount(obj){
		var trNode = obj.closest('tr');
		savingAccountId = $(trNode).find('div:first').next;
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.savingAccount.activeAccount"/>');
	}
	...
	function clientScreenReport(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.clientScreenReports"/>');
	}
	
	function uploadClientSignature(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.uploadClientSignature"/>');
	}
	
	function viewStandingInstraction(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.viewStandingInstruction"/>');
	}
	
	function createStandingInstraction(){
		$.openWindow('<c:url value="/loadPage.do?nextPage=client.client.standingInstruction"/>');
	}
