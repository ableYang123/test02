...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			...
			<form class="form-horizontal" id="uploadFile" name="uploadFile">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="description" name="description" rows="5" cols="30">
						</div>
					</div>
					<div class="form-group">
	...
	<script type="text/javascript">
		$(document).ready(function() {
				...
				$.getWidget("save").click(function() {
					...
					$.uploadFile('uploadFile',url,callback);
			});
		});
		function callback(param) {
			$.setReadOnly("uploadFile");
