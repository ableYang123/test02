...
<form class="form-horizontal" id="addFixedDPForm" name="addFixedDPForm">
	<fieldset>
		...
		<div class="form-group">
			<label for="fromDate" class="col-sm-2 control-label"><spring:message code="deposit.label.fromDate" /><span style="color: #d9534f;">*</span></label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="isPrimaryGroupingByAmount" class="col-sm-2 control-label"><spring:message code="deposit.label.isPrimaryGroupingByAmount" /><span style="color: #d9534f;">*</span></label>
			<div class="col-sm-1">
...
<script type="text/javascript">
				...
				$.valid("addFixedDPForm", 
				 ...
				 $.nest({
					...
					data : {
						"dataType" : "GET",
						"mydata" : '',
						"url" : "api.v1.recurringdepositproducts."+recurDPId+'?template=true'
					},
					callback : "editBack"
				});
	...
	function editBack(param) {
		...
		$.assign({
			...
			"minBalanceForInterestCalculation":param.minBalanceForInterestCalculation
