...
<body style="background: color:#fff">
	<div>
		<div style="margin: 30px 200px; font-size: large">
			<ul class="breadcrumb">
				<li class="active"><a href="#"><spring:message code="deposit.title.fixed.list"/></a></li>
			</ul>
		</div>
		<div class="div-cc">
			<table id="fixedDPList" style="display: none;">
				<thead>
					<tr>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			grid1 = $('#fixedDPList').flexigrid(
									{
										title : '<spring:message code="deposit.title.fixed.list"/>',
										pcpager:true,
										buttons : [
												{
		...
		function ADD() {
			$.openWindow("loadPage.do?nextPage=product.fixedDepositProducts.add_fixedDepositProduct");
		}

		function EDIT() {
			fixedDPId = grid1.colVal('id');
			$.openWindow("loadPage.do?nextPage=product.fixedDepositProducts.edit_fixedDepositProduct");
		}

		/* function DETAIL(){
			fixedDPId = grid1.colVal('id');
			$.openWindow("loadPage.do?nextPage=product.fixedDepositProducts.fixedDepositProductDetail");
		} */
