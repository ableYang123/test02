...
<form class="form-horizontal" id="addFixedDPForm" name="addFixedDPForm">
	<fieldset>
		<legend>
			<spring:message code="deposit.title.fixed.create" />
		</legend>
		<div>
			<h3>
				<spring:message code="deposit.label.details" />
			</h3>
		</div>

		<div class="form-group">
			<label for="name" class="col-sm-2 control-label">
				<spring:message code="deposit.label.product.name" />
			...
			<label for="shortName" class="col-sm-2 control-label">
				<spring:message code="deposit.label.shortName" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="description" class="col-sm-2 control-label">
				<spring:message code="deposit.label.description" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-4">
		...
		<div>
			<h3>
				<spring:message code="deposit.label.currency" />
			</h3>
		</div>

		<div class="form-group">
			<label for="currencyCode" class="col-sm-2 control-label">
				<spring:message code="deposit.label.currency" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
			...
			<label for="digitsAfterDecimal" class="col-sm-2 control-label">
				<spring:message code="deposit.label.digitsAfterDecimal" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="inMultiplesOf" class="col-sm-2 control-label">
				<spring:message code="deposit.label.inMultiplesOf" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div>
			<h3>
				<spring:message code="deposit.label.terms" />
			</h3>
		</div>

		<div class="form-group">
			<label for="depositAmount" class="col-sm-2 control-label">
				<spring:message code="deposit.label.depositAmount" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="minDepositAmount" class="col-sm-2 control-label">
				<spring:message code="deposit.label.minDepositAmount" />
			</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" id="minDepositAmount" name="minDepositAmount" />
			</div>
			<label for="maxDepositAmount" class="col-sm-2 control-label">
				<spring:message code="deposit.label.maxDepositAmount" />
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="interestCompoundingPeriodType" class="col-sm-2 control-label">
				<spring:message code="deposit.label.interestCompoundingPeriodType" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
			...
			<label for="interestPostingPeriodType" class="col-sm-2 control-label">
				<spring:message code="deposit.label.interestPostingPeriodType" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="interestCalculationType" class="col-sm-2 control-label">
				<spring:message code="deposit.label.interestCalculationType" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
			...
			<label for="interestCalculationDaysInYearType" class="col-sm-2 control-label">
				<spring:message code="deposit.label.interestCalculationDaysInYearType" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div>
			<h3>
				<spring:message code="deposit.label.settings" />
			</h3>
		</div>

		<div class="form-group">
			<label for="lockinPeriodFrequency" class="col-sm-2 control-label">
				<spring:message code="deposit.label.lockinPeriodFrequency" />
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="inMultiplesOfDepositTerm" class="col-sm-2 control-label">
				<spring:message code="deposit.label.inMultiplesOfDepositTerm" />
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="minDepositTerm" class="col-sm-2 control-label">
				<spring:message code="deposit.label.minDepositTerm" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="maxDepositTerm" class="col-sm-2 control-label">
				<spring:message code="deposit.label.maxDepositTerm" />
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label for="preClosurePenalApplicable" class="col-sm-2 control-label">
				<spring:message code="deposit.label.preClosurePenalApplicable" />
			</label>
			<div class="col-sm-1">
			...
			<label class="col-sm-3 control-label preClosurePenalInterest">
				<spring:message code="deposit.label.preClosurePenalInterest" />
			</label>
			...
			<label class="col-sm-1 preClosurePenalInterest">
				<spring:message code="deposit.label.type" />
			</label>
		...
		<div class="form-group">
			<label for="withHoldTax" class="col-sm-2 control-label">
				<spring:message code="deposit.label.withHoldTax" />
			</label>
			<div class="col-sm-3">
				<label class="checkbox">
					<input id="withHoldTax" type="checkbox">
				</label>
			</div>
			<label for="taxGroupId" class="col-sm-2 control-label taxGroup">
				<spring:message code="deposit.label.taxGroup" />
			</label>
		...
		<div>
			<h3>
				<spring:message code="deposit.label.interestRateChart" />
			</h3>
		</div>

		<div class="form-group">
			<label for="fromDate" class="col-sm-2 control-label">
				<spring:message code="deposit.label.fromDate" />
				<span style="color: #d9534f;">*</span>
			</label>
			<div class="col-sm-3">
				<input type="text" datetype="date" name="fromDate" beforeToday="false" local-date="true"/>
			</div>
			<label for="endDate" class="col-sm-2 control-label">
				<spring:message code="deposit.label.endDate" />
			</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<div class="col-sm-10">
				<table class="table" id="chartTable">
					<tr>
						<td>
							<spring:message code="deposit.label.amountRange" />
						</td>
						<td>
							<spring:message code="deposit.label.period" />
						</td>
						<td>
							<spring:message code="deposit.label.periodType" />
						</td>
						<td>
							<spring:message code="deposit.label.interest" />
						</td>
						<td>
							<spring:message code="deposit.label.description" />
						</td>
						<td>
							<spring:message code="deposit.label.action" />
						</td>
					</tr>
		...
		<div>
			<h3>
				<spring:message code="deposit.label.charges" />
			</h3>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<table class="table" id="chargesTable">
					<tr>
						<td>
							<spring:message code="deposit.label.name" />
						</td>
						<td>
							<spring:message code="deposit.label.type" />
						</td>
						<td>
							<spring:message code="deposit.label.amount" />
						</td>
						<td>
							<spring:message code="deposit.label.collectedOn" />
						</td>
						<td>
							<spring:message code="deposit.label.action" />
						</td>
					...
					<tr style="display: none;">
						<td>
							<span name="chargeName" id=""></span>
						</td>
						<td>
							<span name="chargeType"></span>
						</td>
						<td>
							<span name="chargeAmount"></span>
						</td>
						<td>
							<span name="chargeCollectedOn"></span>
						</td>
						<td>
							<button type="button" class="btn btn-link " onclick="deleteTr(this)">
								<span class="glyphicon glyphicon-remove"></span>
		...
		<div id="cashFrom">
			...
			<div>
				<h4>
					<spring:message code="deposit.label.assets" />
				</h4>
			</div>
			<div class="form-group">
				<label for="savingsReferenceAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.savingsReferenceAccount" />
				</label>
				<div class="col-sm-3">
			...
			<div>
				<h4>
					<spring:message code="deposit.label.liabilities" />
				</h4>
			</div>
			<div class="form-group">
				<label for="savingsControlAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.savingsControlAccount" />
				</label>
				<div class="col-sm-3">
				...
				<label for="transfersInSuspenseAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.transfersInSuspenseAccount" />
				</label>
				<div class="col-sm-3">
			...
			<div>
				<h4>
					<spring:message code="deposit.label.expenses" />
				</h4>
			</div>
			<div class="form-group">
				<label for="interestOnSavingsAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.interestOnSavingsAccount" />
				</label>
				<div class="col-sm-3">
			...
			<div>
				<h4>
					<spring:message code="deposit.label.income" />
				</h4>
			</div>
			<div class="form-group">
				<label for="incomeFromFeeAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.incomeFromFeeAccount" />
				</label>
				<div class="col-sm-3">
				...
				<label for="incomeFromPenaltyAccountId" class="col-sm-2 ">
					<spring:message code="deposit.label.incomeFromPenaltyAccount" />
				</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<div class="col-sm-8">
					<spring:message code="deposit.label.advanced.account" />
					[
					<a href="javaScript:void(0)" id="showAccount">
						<spring:message code="deposit.label.show" />
					</a>
					]
				</div>
			</div>
			<div id="advancedAccount">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<span>
							<spring:message code="deposit.msg.cash.paymentType" />
						</span>
						<table class="table" id="paymentChannelsTable">
							<tr>
								<td>
									<spring:message code="deposit.label.paymentType" />
								</td>
								<td>
									<spring:message code="deposit.label.fundSourceAccount" />
								</td>
								<td>
									<spring:message code="deposit.label.action" />
								</td>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<span>
							<spring:message code="deposit.msg.cash.fees" />
						</span>
						<table class="table" id="mapFeesTable">
							<tr>
								<td>
									<spring:message code="deposit.label.fees" />
								</td>
								<td>
									<spring:message code="deposit.label.incomeAccount" />
								</td>
								<td>
									<spring:message code="deposit.label.action" />
								</td>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<span>
							<spring:message code="deposit.msg.cash.penalty" />
						</span>
						<table class="table" id="mapPenaltiesTable">
							<tr>
								<td>
									<spring:message code="deposit.label.penalty" />
								</td>
								<td>
									<spring:message code="deposit.label.incomeAccount" />
								</td>
...
<script type="text/javascript">
					...
					function() {
						...
						$.nest({
							...
							data : {
								"dataType" : "GET",
								"mydata" : '',
								"url" : "api.v1.fixeddepositproducts.template"
							},
							callback : "add_back"
						});
								...
								.click(
										function() {
											if ($
												...
												var interestCalculationDaysInYearType = $
												...
												var minDepositTerm = $(
														'#minDepositTerm')
														.val();
												var minDepositTermTypeId = $
														.value("minDepositTermTypeId");

												//account
												var accountingRule = $(
														'input[name="accountingRule"]:checked')
														.val();
												...
												/*settings非必填项*/
												var lockinPeriodFrequency = $(
														'#lockinPeriodFrequency')
														.val();
												var lockinPeriodFrequencyType = $
														.value("lockinPeriodFrequencyType");
												var inMultiplesOfDepositTerm = $(
														'#inMultiplesOfDepositTerm')
														.val();
												var inMultiplesOfDepositTermTypeId = $
														.value("inMultiplesOfDepositTermTypeId");
												var maxDepositTerm = $(
														'#maxDepositTerm')
														.val();
												var maxDepositTermTypeId = $
														.value("maxDepositTermTypeId");
												...
												var preClosurePenalApplicable = $(
														'#preClosurePenalApplicable')
														.is(':checked');

												if (preClosurePenalApplicable) {

													var preClosurePenalInterest = $(
															'#preClosurePenalInterest')
															.val();
													var preClosurePenalInterestOnTypeId = $
															.value("preClosurePenalInterestOnTypeId");
														...
														.each(
																function() {
																	var amountRangeFrom = $(
																			this)
																			.find(
																					'input[name="amountRangeFrom"]')
																			.val();
																	var amountRangeTo = $(
																			this)
																			.find(
																					'input[name="amountRangeTo"]')
																			.val();
																	var fromPeriod = $(
																			this)
																			.find(
																					'input[name="fromPeriod"]')
																			.val();
																	var toPeriod = $(
																			this)
																			.find(
												...
												//account:cash
												if (accountingRule == 2) {
													var savingsReferenceAccountId = $
															.value("savingsReferenceAccountId");
													var savingsControlAccountId = $
															.value("savingsControlAccountId");
													var transfersInSuspenseAccountId = $
															.value("transfersInSuspenseAccountId");
													var interestOnSavingsAccountId = $
															.value("interestOnSavingsAccountId");
													var incomeFromFeeAccountId = $
															.value("incomeFromFeeAccountId");
													var incomeFromPenaltyAccountId = $
													...
													$('#paymentChannelsTable')
															...
															.each(
																	function() {
																		...
																		var paymentTypeId = parseInt($(
																				this)
																				.find(
																						'select[name="paymentTypeId"]')
																				.val());
																		var fundSourceAccountId = parseInt($(
																				this)
																				.find(
																						'select[name="fundSourceAccountId"]')
																				.val());
																		var rowJson = {
													...
													$('#mapFeesTable')
															...
															.each(
																	function() {
																		...
																		var f_chargeId = parseInt($(
																				this)
																				.find(
																						'select[name="f_chargeId"]')
																				.val());
																		var f_incomeAccountId = parseInt($(
																				this)
																				.find(
																						'select[name="f_incomeAccountId"]')
																				.val());
																		var rowJson = {
																			"chargeId" : f_chargeId,
													...
													$('#mapPenaltiesTable')
															...
															.each(
																	function() {
																		...
																		var p_chargeId = parseInt($(
																				this)
																				.find(
																						'select[name="p_chargeId"]')
																				.val());
																		var p_incomeAccountId = parseInt($(
																				this)
																				.find(
																						'select[name="p_incomeAccountId"]')
																				.val());
																		var rowJson = {
																			"chargeId" : p_chargeId,
												...
												$
														.nest({
															...
															data : {
																...
																"dataType" : "POST",
																"mydata" : json,
																"url" : "api.v1.fixeddepositproducts"
															},
	...
	function add_back(param) {

		$.setSelect('currencyCode', param.currencyOptions, 'code', 'name');
		$.setSelect('interestCompoundingPeriodType',
				param.interestCompoundingPeriodTypeOptions, 'id', 'value');
		$.setSelect('interestPostingPeriodType',
				param.interestPostingPeriodTypeOptions, 'id', 'value');
		$.setSelect('interestCalculationType',
				param.interestCalculationTypeOptions, 'id', 'value');
		$.setSelect('interestCalculationDaysInYearType',
				param.interestCalculationDaysInYearTypeOptions, 'id', 'value');
		$.setSelect('periodFrequencyTypeOptions',
				param.periodFrequencyTypeOptions, 'id', 'value');
		$.setSelect('lockinPeriodFrequencyType',
				param.lockinPeriodFrequencyTypeOptions, 'id', 'value');
		$.setSelect('inMultiplesOfDepositTermTypeId',
				param.periodFrequencyTypeOptions, 'id', 'value');
		$.setSelect('minDepositTermTypeId', param.periodFrequencyTypeOptions,
				'id', 'value');
		$.setSelect('maxDepositTermTypeId', param.periodFrequencyTypeOptions,
				'id', 'value');
		$.setSelect('preClosurePenalInterestOnTypeId',
				param.preClosurePenalInterestOnTypeOptions, 'id', 'value');
		$.setSelect('taxGroupId', param.taxGroupOptions, 'id', 'name');
		$.setSelect('periodType', param.periodFrequencyTypeOptions, 'id',
				'value');
		$.setSelect('charges', param.chargeOptions, 'id', 'name');
		//console.log(param.accountingRule.id);
		//$('input:radio:first').attr('checked', 'checked');
		$('input:radio').eq(param.accountingRule.id - 1)
				.attr('checked', 'true');

		$.setSelect('savingsReferenceAccountId',
				param.accountingMappingOptions.assetAccountOptions, 'id',
				'name');
		$.setSelect('savingsControlAccountId',
				param.accountingMappingOptions.liabilityAccountOptions, 'id',
				'name');
		$.setSelect('transfersInSuspenseAccountId',
				param.accountingMappingOptions.liabilityAccountOptions, 'id',
				'name');
		$.setSelect('interestOnSavingsAccountId',
				param.accountingMappingOptions.expenseAccountOptions, 'id',
				'name');
		$.setSelect('incomeFromFeeAccountId',
				param.accountingMappingOptions.incomeAccountOptions, 'id',
				'name');
		$.setSelect('incomeFromPenaltyAccountId',
				param.accountingMappingOptions.incomeAccountOptions, 'id',
				'name');

		$.setSelect('paymentTypeId', param.paymentTypeOptions, 'id', 'name');
		$.setSelect('fundSourceAccountId',
				param.accountingMappingOptions.assetAccountOptions, 'id',
				'name');
		...
		$.setSelect('f_incomeAccountId',
				param.accountingMappingOptions.incomeAccountOptions, 'id',
				'name');
		$.setSelect('p_chargeId', param.penaltyOptions, 'id', 'name');
		$.setSelect('p_incomeAccountId',
				param.accountingMappingOptions.incomeAccountOptions, 'id',
				'name');
	}
	...
	function addChargesBack(param) {
		...
		$('#chargesTable').find('tr').last().find('span[name="chargeName"]')
				.attr("id", param.id);
		$('#chargesTable').find('tr').last().find('span[name="chargeName"]')
				.text(param.name);
		$('#chargesTable').find('tr').last().find('span[name="chargeType"]')
				.text(param.name);
		$('#chargesTable').find('tr').last().find('span[name="chargeAmount"]')
				.text(param.chargeCalculationType.value);
		$('#chargesTable').find('tr').last().find(
				'span[name="chargeCollectedOn"]').text(
				param.chargeTimeType.value);
	}
