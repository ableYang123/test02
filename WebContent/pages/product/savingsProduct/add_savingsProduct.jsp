...
<form class="form-horizontal"  id="add_savingsProduct" name="add_savingsProduct" >
<fieldset>
		<legend>
			<spring:message code="deposit.savings.product.create" />
		</legend>
	...
	<div><h3><spring:message code="deposit.label.terms" /></h3></div>
		...
		<div class="form-group">
			...
			<label for="interestCalculationDaysInYearType" class="col-sm-2 control-label"><spring:message code="deposit.day.of.year" /><span style="color: #d9534f;">*</span> </label>
			<div class="col-sm-3">
...
<div class="form-group">
	...
	<div class="form-group" id="div4">		
			<label  class="col-sm-2 control-label"><spring:message code="deposit.tax.team" /></label>
			<div  class="col-sm-4">
...
<div id="div06"><h3><spring:message code="deposit.label.expense" /></h3></div>
...
function addChargesBack(param){
  ...
  $(document).ready(function(){
	$.hide("hideButton","chargesTable","button3","button2","button1","show","div1","div2","div3","div4","div5","div6","div7","div01","div02","div03","div04","div05","div06","div07","div08","div09","div10","div11");
	...
	},
	{
	 ...
	 $.getWidget("save").click(function() {
		...
		date={
				...
				"nominalAnnualInterestRate":$.value('nominalAnnualInterestRate'),
...
function callbackadd(param) {
	$.setReadOnly("add_savingsProduct");
