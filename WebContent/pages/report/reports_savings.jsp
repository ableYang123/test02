...
<body style="background: color:#fff">
	<div>
		<div style="margin: 30px 200px; font-size: large">
			<ul class="breadcrumb">
				<li class="active"><a href="#"><spring:message code="label.report.savingsReport"/></a></li>
			</ul>
		</div>
		<div class="div-cc">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			grid1 = $('#reportsList').flexigrid(
									{
										title : '<spring:message code="label.report.savingsReport"/>',
										pcpager:true,
										buttons : 
												[{
		...
		function init() {
			$.nest({
				...
				data : {
					"dataType" : "GET",
					"mydata" : "",
					"url" : "api.v1.runreports.reportCategoryList?R_reportCategory=Savings&genericResultSet=false&parameterType=true"//只获取useReport为true的数据
				},
				callback : "callback"
			});
		}
