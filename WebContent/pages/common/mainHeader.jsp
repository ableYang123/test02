...
<body style="height: 95.7%">
<div id="myModal" class="modal fade bs-example-modal-lg"  style="position: absolute;z-index: 100;height: 100%" tabindex="-1" role="dialog" data-backdrop="static"> 
  <div class="modal-dialog modal-lg" role="document" id="modal-dialog" name="modal-dialog">
    <div class="modal-content" style="font-size: large;height: 100%">
		...
		<div class="modal-body" id="modal-body" name="modal-body" style="height: 90%">
		</div>
    </div>
  </div>
</div>
