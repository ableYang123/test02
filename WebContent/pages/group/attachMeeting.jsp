...
<form class="form-horizontal" id="attachMeetingGroup" name="attachMeetingGroup" method="post">
	<fieldset>
		<legend><spring:message code="group.attach.meeting"/></legend>

		<div class="form-group">
			<label class="col-sm-2 control-label"><spring:message code="group.start.date"/>
		...
		<div class="form-group">
			<label for="repeat" class="col-sm-2 control-label"><spring:message code="group.repeat"/></label>
			<div class="col-sm-3">
			...
			<div label="detail">
				...
				<label class="col-sm-2 control-label" style="padding-top: 10px;">
					<h4 style="padding-top: 10px;"><spring:message code="group.repeat.details"/></h4>
				</label>
			</span>
			<br/>
			<table width="40%">
 ...
 <script type="text/javascript">
	       ...
	       $(document).on('change',"#frequency",function(){
	    	 ...
	    	 if(category == 'weekly'){
	       	...
	       	$.getWidget('save').click(function(){
	       		if($.validateForm("attachMeetingGroup")){
	       			var json = { 
	       					"repeating":""+flag,
	       			...
	       			$.nest({
	          			...
	          			data : {
	          				"dataType" : "POST",
	          				"mydata" : json,
	          				"url" : "api.v1.groups."+groupId+".calendars",
        ...
        function init(){
        	  $.nest({
      			...
      			data : {
      				"dataType" : "GET",
      				"mydata" : "",
      				"url" : "api.v1.groups."+groupId+".calendars.template"
      			},
      			callback : "callback1"
      		 }); 
        }
      ...
      function attach_success(param){
    	$.setReadOnly("attachMeetingGroup");
